...
var Game = {
    ...
    create  : function() {
        ...
        aliensString = 'Alien: ';
        alienscount = game.add.text(735,70,aliensString + aliens.countLiving(), { font: '40px Arial', fill: '#fff' });

        alienString = 'Kill: ';
        alienkillText = game.add.text(735,110,alienString + alienkill, { font: '40px Arial', fill: '#fff' });
